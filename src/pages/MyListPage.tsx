...
import { Film, History, Pencil, X, Check } from 'lucide-react';
...
const MyListPage = () => {
  ...
  const handleSelectAll = () => {
    if (selectedVideos.length === savedVideos.length) {
      ...
      setSelectedVideos(savedVideos.map(video => video.content_id));
    }
  };
      ...
      <div className="px-4 pt-4">
        {activeTab === 'mylist' ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Watch history coming soon</p>
          </div>
        )}
      </div>

      {isEditing && savedVideos.length > 0 && (
